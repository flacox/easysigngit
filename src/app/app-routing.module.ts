...
const routes: Routes = [
  ...
  {
    path: 'quiz1',
    loadChildren: () => import('./quizzes/quiz1/quiz1.module').then( m => m.Quiz1PageModule)
  },
  {
    path: 'quiz2',
    loadChildren: () => import('./quizzes/quiz2/quiz2.module').then( m => m.Quiz2PageModule)
  },
  {
    path: 'quiz3',
    loadChildren: () => import('./quizzes/quiz3/quiz3.module').then( m => m.Quiz3PageModule)
  },
  {
    path: 'home-quiz',
